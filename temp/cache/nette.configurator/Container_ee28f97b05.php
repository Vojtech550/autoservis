<?php
// source: D:\xampp\htdocs\www\autoservis/config/common.neon
// source: D:\xampp\htdocs\www\autoservis/config/local.neon
// source: array
...
class Container_ee28f97b05 extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Presenters\MajitelePresenter' => [2 => ['application.4']],
		'App\Presenters\OpravyPresenter' => [2 => ['application.5']],
		'App\Presenters\SignPresenter' => [2 => ['application.6']],
		'App\Presenters\SoucastkyPresenter' => [2 => ['application.7']],
		'App\Presenters\TypVozuPresenter' => [2 => ['application.8']],
		'App\Presenters\ZamestnanciPresenter' => [2 => ['application.9']],
	...
	public function createService02(): App\Model\Main_model
	{
		return new App\Model\Main_model($this->getService('database.default.context'));
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
		...
		$service->injectContext($this->getService('database.default.context'));
		$service->invalidLinkMode = 5;
		return $service;
	}


	public function createServiceApplication__4(): App\Presenters\MajitelePresenter
	{
		$service = new App\Presenters\MajitelePresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__5(): App\Presenters\OpravyPresenter
	{
		$service = new App\Presenters\OpravyPresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__7(): App\Presenters\SoucastkyPresenter
	{
		$service = new App\Presenters\SoucastkyPresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__8(): App\Presenters\TypVozuPresenter
	{
		$service = new App\Presenters\TypVozuPresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__9(): App\Presenters\ZamestnanciPresenter
	{
		$service = new App\Presenters\ZamestnanciPresenter($this->getService('02'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\xampp\htdocs\www\autoservis/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\xampp\htdocs\www\autoservis/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('D:\xampp\htdocs\www\autoservis/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_ee28f97b05
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=autoservis', 'root', null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_ee28f97b05 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\xampp\htdocs\www\autoservis/temp/cache/latte');
